...
typedef struct
{
	...
	lv_obj_t *screen_1_spinbox_2;
	lv_obj_t *screen_1_spinbox_2_btn_plus;
	lv_obj_t *screen_1_spinbox_2_btn_minus;
	lv_obj_t *screen_1_spinbox_3;
	lv_obj_t *screen_1_spinbox_3_btn_plus;
	lv_obj_t *screen_1_spinbox_3_btn_minus;
